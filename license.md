...
You (“Evaluator”) are granted ONLY the following rights:



Right to view the Software.



Right to locally execute the Software for the sole purpose of evaluation.
...
Upload the Software to any external system
...
Translate, port, or adapt the Software



Re‑implement the Software’s architecture, design, flow, or structure
...
Use the Software to design competing systems
...
Build products using the same reflex system



Build products using the same sonar pipeline
...
are owned exclusively by Thomas Price.



Evaluator receives zero ownership and zero IP rights.



4\. No License to Use the Design

Evaluator is explicitly forbidden from using:
...
This license automatically terminates if Evaluator:
...
Attempts to use the Software beyond evaluation



Attempts to copy, modify, or reverse engineer



Attempts to use the Software in any product or system
...
Build products using the Software



Build products using the architecture



Build products using the design
...
Commercial licensing is the only legal path forward.
...
Until such purchase occurs, Evaluator has zero rights beyond evaluation.



8\. No Warranty

Software is provided “AS IS” with:
...
The Commonwealth of Kentucky, United States
